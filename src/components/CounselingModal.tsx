...
// Joined without blank lines between points (unlike the fields below) -- the
// PDF's Key Points box is fixed-height and can't fit this much text at a
// readable size with extra blank-line spacing between all 19 points.
const INITIAL_COUNSELING_KEY_POINTS = [
...
const INITIAL_COUNSELING_PLAN_OF_ACTION = [
...
const INITIAL_COUNSELING_LEADER_RESPONSIBILITIES = [
